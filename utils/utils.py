...
def create_custom_period(start='', end=''):
    df_custom = pd.read_csv(Path.cwd() / 'static/Cartuja_Datos/EDAR4.0_EDAR_Cartuja_ID_PERIOD_2.csv',
    ...
    df_custom.to_csv(Path.cwd() / 'static/Cartuja_Datos/EDAR4.0_EDAR_Cartuja_ID_PERIOD_CUSTOM.csv', index=False, sep=',', encoding='latin-1', decimal='.')